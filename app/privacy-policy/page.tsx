      ...
      <div className="max-w-3xl mx-auto px-6 md:px-0">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
          ...
          <p className="text-base md:text-lg text-accent-black/70 leading-relaxed">
            This page explains what information Roses by Lina collects when you use this site,
            how it&apos;s used, and who it&apos;s shared with. Last updated August 2026.
          </p>
        </motion.div>
        ...
        <div className="mt-16 space-y-12">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <p className="text-accent-black/70 leading-relaxed">
              ...
              overall site traffic; it does not use tracking cookies or collect personal information.
            </p>
          </motion.div>

          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h2 className="text-2xl font-light text-accent-black mb-4">How We Use Your Information</h2>
            <p className="text-accent-black/70 leading-relaxed">
              ...
              payment. We don&apos;t sell your information or use it for advertising, and we won&apos;t
              email you marketing messages without your consent.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <p className="text-accent-black/70 leading-relaxed">
              ...
              <a href="mailto:albert.marrero10@gmail.com" className="underline font-medium hover:text-black">
